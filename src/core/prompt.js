...
export const DATA_OPEN = '-----BEGIN LEAD DATA-----';
export const DATA_CLOSE = '-----END LEAD DATA-----';
...
export const STRICT_RETRY_REMINDER =
...
export const SCORING_RESPONSE_SCHEMA = Object.freeze({
  type: 'object',
 ...
 */
export function wrapUntrusted(raw) {
 ...
 */
export function buildScoringPrompt(lead, options) {
  const l = lead ?? {};
